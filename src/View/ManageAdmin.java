...
import Controller.ManageAdminController;
...
public class ManageAdmin extends javax.swing.JFrame {    
    ...
    public ManageAdmin(int idUser) {
        initComponents();
        this.idUser = idUser;
        controller = new ManageAdminController(this, idUser);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageAdmin(idUser).setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    public javax.swing.JTable adminTbl;
